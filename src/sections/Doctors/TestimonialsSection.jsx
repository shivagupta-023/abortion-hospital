...
const testimonials = [
  {
    quote: "I flew from the UK not knowing what to expect. Dr. Rupali made me feel like I was talking to a close friend — no judgment, no rush, just complete care. I cannot thank her enough for how safe she made me feel.",
    name: "Sarah M.",
  ...
  {
    quote: "I was 18 weeks and had been turned away from two other clinics. Dr. Rupali handled everything — the medical board, the paperwork, everything. I never had to worry about anything except recovering.",
    name: "Nadia K.",
    country: "Kazakhstan",
    flag: "🇰🇿",
    doctor: "Dr. Rupali",
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "0 2px 20px rgba(39,68,93,0.06)",
      }}
    >
      ...
      {/* Quote */}
      <p
        className={`font-body leading-relaxed text-teal/70 flex-1 ${large ? "text-base sm:text-lg" : "text-sm"}`}
      >
        {t.quote}
      </p>

      {/* Divider */}
      <div className="h-px" style={{ background: "rgba(113,187,178,0.1)" }} />
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-display font-semibold text-teal text-sm leading-none mb-0.5">{t.name}</p>
            <p className="text-[10px] font-body text-teal/45 flex items-center gap-1">
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          <span
            ...
            style={{ background: "rgba(39,68,93,0.05)", color: "rgba(39,68,93,0.45)", border: "1px solid rgba(39,68,93,0.08)" }}
          >
            {t.weeks}
          </span>
        </div>
...
export default function TestimonialsSection() {
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(160deg, #f0faf9 0%, #e8f5f3 55%, #f4fbf9 100%)" }}
    >
      <div className="container-main">
        ...
        <div
          ...
          style={{ background: "rgba(255,255,255,0.7)", border: "1.5px solid rgba(113,187,178,0.15)", backdropFilter: "blur(8px)" }}
        >
          {[
            ...
            <div key={s.label} className="text-center">
              <p className="font-display font-bold text-teal text-xl sm:text-2xl leading-none mb-1">{s.value}</p>
              <p className="text-[10px] font-body uppercase tracking-wider text-teal/45">{s.label}</p>
            </div>
          ))}
        </div>
